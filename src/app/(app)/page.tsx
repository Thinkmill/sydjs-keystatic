...
const Header = asyncComponent(async function Header() {
...
const Events = asyncComponent(async function Events() {
  const { pastEvents, nextEvent } = await getEvents()
  return (
    <>
      <div className="mx-auto max-w-7xl px-6">
        {nextEvent && <EventListingCard slug={nextEvent.slug} />}
      </div>
